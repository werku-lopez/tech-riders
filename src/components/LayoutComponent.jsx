...
const LayoutComponent = ({ children }) => {
  ...
  let Links = [
    ...
    { name: "Colaboradores", link: "/todasempresas" },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-neutral-50 absolute inset-0 -z-10 h-fit w-full  bg-[radial-gradient(#d6ebf5_1px,transparent_1px)] [background-size:16px_16px] ">
      ...
      <footer class="bg-neutral-50 border-t-2 border-primary-500 ">
        <div class="mx-auto w-full max-w-screen-xl bg-neutral-50 p-4 py-6 lg:py-8">
          <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center ">
                <img
                  src={logoTajamar}
                  class="h-8 me-3 invert"
                  alt="FlowBite Logo"
                />
                <span class="self-center text-2xl font-semibold whitespace-nowrap text-primary-500">
                  Tech Riders
                </span>
              </a>
            </div>
